...
void Transform::Rotate(float x, float y, float z, bool world)
{
	...
	if (world)
		_rotation = newRotation * _rotation; //crea la rotacion a partir de la que nos dice 
	else
		_rotation = _rotation * newRotation; //la rotacion a partir de la rotacíon actual
